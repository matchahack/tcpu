...
python programmer.py -p /dev/ttyUSB2 -b 115200 -i "[0x60, 0x20, 0x60, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF]"
python programmer.py -p /dev/ttyUSB2 -b 115200 -i "[0x20, 0x85, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20]"
python programmer.py -p /dev/ttyUSB2 -b 115200 -i "[0x20, 0xA0, 0x20, 0xC0, 0x40, 0xFF, 0xFF, 0xFF]"
python programmer.py -p /dev/ttyUSB2 -b 115200 -i "[0x20, 0xA0, 0x20, 0xC0, 0x00, 0xFF, 0xFF, 0xFF]"
```